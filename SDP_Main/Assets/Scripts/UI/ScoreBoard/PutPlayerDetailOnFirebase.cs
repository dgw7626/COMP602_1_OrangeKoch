...
public class PutPlayerDetailOnFirebase : MonoBehaviour 
{
 ...
 // The start methode put the player detail on Firebase with help of RestClient.   
    ...
    public void team_1player_2Detail(string playerName, int kills, int deaths)
    {
        ...
        RestClient.Put("https://project-10bbb-default-rtdb.firebaseio.com/player1.json", scoreMan2);
    }
    ...
    public void team_1player_3Detail(string playerName, int kills, int deaths)
    {
        ...
        RestClient.Put("https://project-10bbb-default-rtdb.firebaseio.com/player1.json", scoreMan3);
    }
    ...
    public void team_2player_1Detail(string playerName, int kills, int deaths)
    {
        ...
        RestClient.Put("https://project-10bbb-default-rtdb.firebaseio.com/player1.json", scoreMan4);
    }
    ...
    public void team_2player_2Detail(string playerName, int kills, int deaths)
    {
        ...
        RestClient.Put("https://project-10bbb-default-rtdb.firebaseio.com/player1.json", scoreMan5);
    }
    ...
    public void team_2player_3Detail(string playerName, int kills, int deaths)
    {
        ...
        RestClient.Put("https://project-10bbb-default-rtdb.firebaseio.com/player1.json", scoreMan6);
    }
    ...
    public void winningTeamName(int winningTeamName)
    {
        ...
        RestClient.Put("https://project-10bbb-default-rtdb.firebaseio.com/player1.json", winningTeam);
    ...
    public void team_1TotalKills(int team_1TotalKills)
    {
        ...
        RestClient.Put("https://project-10bbb-default-rtdb.firebaseio.com/player1.json", totalKills);
    }
